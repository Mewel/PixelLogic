...
public class PixelLogicUILevelPage extends PixelLogicUIPage {
    ...
    protected void updateLevelBounds(int width, int height) {
        ...
        int safeBottom = Gdx.graphics.getSafeInsetBottom();
        int toolbarHeightAndPadding = PixelLogicUIUtil.getToolbarHeight() + PixelLogicUIUtil.getToolbarPaddingTop();

        int levelMaxHeight = Math.min(PixelLogicUIUtil.getLevelMaxHeight(), height - safeTop - safeBottom);
        ...
        float y = safeBottom + toolbarHeightAndPadding + (levelMaxHeight / 2f - this.levelUI.getHeight() / 2f);
    ...
    protected void updateToolbarBounds(int width) {
        ...
        int safeBottom = Gdx.graphics.getSafeInsetBottom();
        this.toolbar.setBounds(0, safeBottom, width, toolbarHeight);
    }
