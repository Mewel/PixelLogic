...
/*
        ...
        assertTrue("there should be changes", solver.blockLine(line, Arrays.asList(2, 2)));
...
*/
        // just one is missing
        Boolean[] line = new Boolean[]{null, null, null, null, true, null, null, null, true, true, true};
        assertTrue("there should be changes", solver.blockLine(line, Arrays.asList(2, 3)));
...
/*
        ...
        assertFalse("there shouldn't be changes", solver.blockLine(line, Arrays.asList(2, 2)));
        ...
        assertTrue("there should be changes", solver.blockLine(line, Arrays.asList(2, 3)));
        assertArrayEquals(new Boolean[]{null, null, false, true, true, true, false, false, false}, line);

        // test the first is already filled
        line = new Boolean[]{null, null, null, true, true, null, null, null};
        assertTrue("there should be changes", solver.blockLine(line, Arrays.asList(2, 1)));
        assertArrayEquals(new Boolean[]{false, false, false, true, true, false, null, null}, line);
        ...
        assertFalse("there should be changes", solver.blockLine(line, Arrays.asList(2)));
